...
const CarFilters = ({ filters }) => {
  ...
  const applyFilters = useCallback((customSortBy = null) => {
    ...
    // Use custom sort value if provided, otherwise use current sortBy state
    const sortValue = customSortBy !== null ? customSortBy : sortBy;
